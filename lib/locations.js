...
export const cities = [
  ...
  },
  {
    ...
    name: "Ankara",
    region: "İç Anadolu",
    note: "Ostim ve İvedik sanayi bölgelerinde küçük ve orta ölçekli işletmelerde çoğunlukla 1,5 ile 3 ton kapasiteli makineler kullanılıyor. Bu segmentte en sık karşılaştığımız kalem LPG karbüratör ayarı ve hidrolik kaçak.",
...
export const otherCities = [
  ...
  "Ardahan", "Artvin", "Aydın", "Balıkesir", "Bartın",
  "Batman", "Bayburt", "Bilecik", "Bingöl", "Bitlis",
  "Bolu", "Burdur", "Çanakkale", "Çankırı", "Çorum",
  "Diyarbakır", "Düzce", "Edirne", "Elazığ", "Erzincan",
  "Erzurum", "Giresun", "Gümüşhane", "Hakkâri", "Hatay",
  "Iğdır", "Isparta", "Kahramanmaraş", "Karabük", "Karaman",
  "Kars", "Kastamonu", "Kilis", "Kırıkkale", "Kırklareli",
  "Kırşehir", "Kütahya", "Malatya", "Mardin", "Muğla",
  "Muş", "Nevşehir", "Niğde", "Ordu", "Osmaniye",
  "Rize", "Samsun", "Şanlıurfa", "Siirt", "Sinop",
  "Şırnak", "Sivas", "Tokat", "Trabzon", "Tunceli",
