...
export const site = {
  ...
  // --- İçerik sahipliği (yapısal veri: author / publisher) ---
  author: {
    name: "Fatih Emin Çakıroğlu",
    url: "https://fatihemincakiroglu.com/",
    jobTitle: "İçerik ve web yayıncılığı",
  },

  // İçeriğin ilk yayın tarihi. Güncelleme tarihi her yayında
  // otomatik olarak derleme tarihi ile yazılır.
  contentPublished: "2026-09-01",
